...
class Contact extends Component {
    ...
    render() {
        return (
            <div>
      <div
        className="max-w-screen-xl mt-20 mb-20 px-8 grid gap-8 grid-cols-1 md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 mx-auto text-gray-900">
        <div className="flex flex-col justify-between">
          <div>
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight">Feedback? <br/>Ik hoor het graag!</h2>
            <div className="text-gray-700 mt-8">
              Liever geen formulier? Stuur een <a href="mailto:rolstoelhockeyapp@gmail.com"><span className="underline">email</span></a>
            </div>
          </div>
        </div>
        <div className="">
          <div>
            <span className="uppercase text-sm text-gray-600 font-bold">Naam</span>
          ...
          <div className="mt-8">
            <span className="uppercase text-sm text-gray-600 font-bold">Bericht</span>
            <textarea
